export const metadata = {
  title: "ChatGPT | ToolIA",
  description:
    "Descubre qué es ChatGPT, para qué sirve, sus ventajas y cómo utilizarlo.",
};
        ...
        <div className="rounded-3xl border bg-white p-8 shadow-sm md:p-12">
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-center">
            ...
            <div>
              ...
              <p className="mt-3 text-lg text-slate-600">
                ...
                analizar, aprender, programar y crear.
              </p>
            </div>
          </div>
          ...
          <section className="mt-12">
            ...
            <p className="mt-4 leading-8 text-slate-600">
              ChatGPT es un asistente de inteligencia artificial que
              permite interactuar mediante conversaciones y utilizar
              la IA para diferentes tareas.
            </p>

            <p className="mt-4 leading-8 text-slate-600">
              Puede ayudarte a escribir textos, aprender conceptos,
              generar ideas, analizar información, programar y organizar
            ...
            <div className="mt-6 grid gap-6 md:grid-cols-2">
              ...
              <div className="rounded-2xl bg-green-50 p-6">
                ...
                <ul className="mt-4 space-y-3 text-green-900">
                  ...
                  <li>✓ Muchas posibilidades de uso</li>
                  <li>✓ Útil para estudio y trabajo</li>
          ...
          <section className="mt-12 rounded-2xl bg-slate-900 p-8 text-white">
            ...
            <p className="mt-4 leading-7 text-slate-300">
              ChatGPT es una opción muy completa para usuarios que
              quieren utilizar inteligencia artificial para diferentes
              tareas. Su utilidad dependerá de las necesidades de cada
              persona y de las funciones disponibles en cada plan.
            </p>
