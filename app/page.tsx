...
const featuredSlugs = ["chatgpt", "gemini", "claude"];
...
const categories = [
  {
    ...
    description:
      "Chatbots, asistentes y herramientas basadas en inteligencia artificial.",
    icon: "🤖",
  },
  {
    name: "Estudio",
    description:
      "Herramientas para aprender, estudiar y organizar información.",
    icon: "📚",
  },
  {
    name: "Productividad",
    description:
      "Recursos para ahorrar tiempo y trabajar de forma más eficiente.",
    icon: "⚡",
  },
  {
    name: "Diseño",
    description:
      "Herramientas para crear imágenes, diseños y contenido visual.",
    icon: "🎨",
  },
];
        ...
        <div className="flex items-end justify-between">
          <div>
            ...
            <p className="mt-3 text-slate-600">
              Algunas de las herramientas disponibles en nuestro
              directorio.
            </p>
          </div>
      ...
      <section className="border-y bg-white py-20">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <p className="mt-3 max-w-2xl text-slate-600">
            Explora diferentes tipos de herramientas para estudiar,
            trabajar, crear contenido y mejorar tu productividad.
          </p>
